...
regionBoundaryNodes = { 'head': {1:[25,26,27,28,29,71,72,73,74,97,98,99,45,46,47,48,]},
						...
						'greatertrochanter': {2: [4,34,29,24,19,18,17,16,15,58,57,56,55,71,74,76,35,40,45,50,14,13,11,8]},
						#~ 'medialcondyle': {4:[0,61,62,63,64,93,94,95,96,113,114,115,44,43,42,41,14,12,9,5]},
						'medialcondyle': {4:[20,15,10,5,0,25,26,27,28,35,36,37,38,70,72,73,60,55,50,45]},
						#~ 'lateralcondyle': {5:[15,64,63,62,61,83,82,81,38,37,36,35,4,3,2,1,0,18,17,16]},
						'lateralcondyle': {5:[0,5,9,12,14,15,19,22,24,41,42,43,44,66,65,63,48,47,46,45]},
						'proximalshaft': {1:[4,77,78,79,61,62,63,64,44,39,34,29,24,19,14,9],
										  2:[0,89,87,84,80,160,159,158,136,137,138,139,113,117,121,125,40,35,30,25,20,15,10,5],
						...
						'distalshaft': {3:[155,156,157,158,159,168,169,170,171,178,179,180],
										...
										5:[15,16,17,18,14,130,131,132,120,121,122,123,100,101,102,103,35,36,37,38]},
						}
...
assemblyElementsNumbers = { 'head': 0, 'greatertrochanter':1, 'proximalshaft':2, 'distalshaft':3, 'lateralcondyle':4, 'medialcondyle':5 }
